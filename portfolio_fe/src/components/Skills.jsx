...
const technicalSkills = [
  { name: "HTML", icon: <FaHtml5 className="text-orange-500" />, percent: 80 },
  { name: "CSS", icon: <FaCss3 className="text-blue-400" />, percent: 60 },
  {
    name: "TailwindCSS",
  ...
  { name: "ReactJs", icon: <FaReact className="text-cyan-600" />, percent: 60 },
